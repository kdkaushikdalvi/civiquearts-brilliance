...
const ResetPasswordPage = () => {
  ...
  useEffect(() => {
    if (!showPassword && !showConfirm) return;
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="pr-10"
                  />
                  <button type="button" onClick={() => setShowConfirm((value) => !value)} className="absolute right-2 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground" aria-label={showConfirm ? "Hide password" : "Show password"}>
